...
\begin{table}[H]
\centering
\caption*{\textbf{Appendix B}: Code Documentation }
\label{t2}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{|llllll|}
\hline
%\textbf{Interaction} &  &  &  &  &  \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}\uline{Code Documentation} - What \\ documentation \\ being used?\end{tabular}}
    & \multicolumn{5}{|l|}{
        \begin{tabular}[c]{lll}
...
%    & \begin{tabular}[c]{@{}l@{}}\Square Geometric Zoom\\ \Square Pan/Translate\\ \Square Rotate\end{tabular} &  &  \\ \cline{2-6}
    ...
    \multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}\uline{Interaction Effectiveness} - Are \\ code documentation provided highly \\ effective? In other words, does \\ the documentation expain in a \\ manner that makes it easy to \\ use or capable of providing rich \\ content?\end{tabular}}
